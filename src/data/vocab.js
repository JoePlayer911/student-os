// src/data/vocab.js
// Multilingual Vocabulary Engine covering 3 languages: Indonesian, English, Chinese
...
export const vocabularyData = [
  ...
  { id: 6, category: "Kalimantan", idn: "Suku Dayak", eng: "Dayak Tribe", cht: "達雅族 (Dá yǎ zú)", chs: "达雅族 (Dá yǎ zú)", desc: "The indigenous people of Borneo, known for their rich oral history and traditions." },
  { id: 7, category: "Kalimantan", idn: "Hutan Hujan", eng: "Rainforest", cht: "雨林 (Yǔlín)", chs: "雨林 (Yǔlín)", desc: "Massive tropical forests covering Borneo, home to incredibly diverse ecosystems." },
  { id: 8, category: "Kalimantan", idn: "Sungai", eng: "River", cht: "河流 (Héliú)", chs: "河流 (Héliú)", desc: "Vast river networks serving as vital transportation routes across the island." },
  { id: 9, category: "Kalimantan", idn: "Buaya", eng: "Crocodile", cht: "鱷魚 (Èyú)", chs: "鳄鱼 (Èyú)", desc: "Large aquatic reptiles that inhabit the rivers and wetlands." },
  { id: 10, category: "Kalimantan", idn: "Ular", eng: "Snake", cht: "蛇 (Shé)", chs: "蛇 (Shé)", desc: "Various species of snakes, including pythons and venomous species, thrive here." },
  ...
  { id: 16, category: "Jawa", idn: "Candi", eng: "Temple", cht: "寺廟 (Sìmiào)", chs: "寺庙 (Sìmiào)", desc: "Ancient Hindu and Buddhist structures found across Java." },
